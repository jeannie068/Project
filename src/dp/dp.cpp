...
/*****modded*****/
bool DPModule::onlyMGL;
bool DPModule::refinementMode;
/*****modded*****/
...
void DPModule::showOptions() const {
    ...
    printlog(LOG_INFO, "ConsiderGrouping   : %s", database.type4CellGroups.size() > 0 ? "true" : "false");
}

bool DPModule::dplace(ripple::ShellOptions& args, ripple::ShellCmdReturn& ret) { //will use this.
    printlog(LOG_INFO, "dplace1");
    // cout << "dplace1"<<endl;
#ifndef NDEBUG
