...
public:
    ...
    // for PPNN cell horizontal separation
    void setSpacingL(int spacing) { _spaceL = spacing; }
    void setSpacingR(int spacing) { _spaceR = spacing; }
    void setCellWidth(int targetWidth) { _type->width = targetWidth; }
