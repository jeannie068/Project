...
public:
    ...
    unordered_map<int, Group*> type4CellGroupsMap;   // for TYPE4 cell group file generated by BOTI's GP engine
    vector<Group*> type4CellGroups;
...
public:
    ...
    bool readGroupFile(const std::string& file);
