...
void Database::clearDesign() {
    ...
    CLEAR_POINTER_LIST(type4CellGroups);
    type4CellGroupsMap.clear();
...
void Database::SetupFloorplan() {
    ...
    // since we only have double height, quadruple height, current siteH = double height
    // we set siteH to become single height
    // std::cout << siteH << endl;
    siteH /=2;
    // std::cout << siteH << endl;
